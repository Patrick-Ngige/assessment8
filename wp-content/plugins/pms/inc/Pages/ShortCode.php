    ...
    public function ViewProjectsPage($props)
    {
        ...
        if (!is_wp_error($response) && $response['response']['code'] === 200) {
            ...
            foreach ($projects as $project) {
                ...
                $html .= '<div class="ms-3">';
                $html .= '<p class="fw-bold mb-1"><i class="bi bi-person-circle" style="margin-right:10px;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" class="bi bi-person-circle" viewBox="0 0 16 16">
